...
const Calendar: React.FC<CalendarProps> = ({ selectedDate, onDateChange }) => {
				...
				<button
                    ...
                    ${
											isSelected
												...
												: "text-[var(--text-muted)] hover:bg-[var(--safari-green-light)] hover:text-[var(--safari-green)]"
										}
	...
	return (
		<div className="card p-4 md:p-6 w-full h-full flex flex-col">
			...
			<div className="grid grid-cols-7 mb-2 text-center">
				{["D", "S", "T", "Q", "Q", "S", "S"].map((day, index) => (
					<div
						key={index}
						className="text-xs font-bold text-[var(--text-muted)] py-1"
					>
						{day}
					</div>
				))}
