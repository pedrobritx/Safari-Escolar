...
_s(AssessmentModal, "dKC0Q0IuokeGk8T1DJ5lk9om/ts=");
_c = AssessmentModal;
var _c;
...
function GradebookPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GradebookPage.useEffect": ()=>{
            const fetchData = {
                "GradebookPage.useEffect.fetchData": async ()=>{
                    try {
                        // 1. Fetch Students
                        ...
                        const mappedStudents = studentsData.map({
                            "GradebookPage.useEffect.fetchData.mappedStudents": (s)=>({
                                    id: s.id,
                                    name: s.display_name,
                                    avatar: s.animal_id,
                                    classroom: s.classroom
                                })
                        }["GradebookPage.useEffect.fetchData.mappedStudents"]);
            ...
            }["GradebookPage.useEffect.fetchData"];
            fetchData();
        }
    }["GradebookPage.useEffect"], []);
...
_s(GradebookPage, "kTUT6crQ2gPAGsKg4Fe+ZF78tyk=");
_c = GradebookPage;
var _c;
...
//# sourceMappingURL=_7518a36f._.js.map