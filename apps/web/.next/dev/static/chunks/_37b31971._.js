...
;
;
function GradebookGrid({ students, categories, items, entries, onUpdateGrade, onEditItem }) {
                    ...
                    children: students.map((student)=>{
                        ...
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                            ...
                            children: [
                                ...
                                items.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
...
function GradebookPage() {
    ...
    const [items, setItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(MOCK_ITEMS);
    const [entries, setEntries] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]); // Start empty
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GradebookPage.useEffect": ()=>{
            const fetchStudents = {
                "GradebookPage.useEffect.fetchStudents": async ()=>{
                    try {
                        ...
                        if (res.ok) {
                            ...
                            const mapped = data.map({
                                "GradebookPage.useEffect.fetchStudents.mapped": (s)=>({
                                        id: s.id,
                                        name: s.display_name,
                                        avatar: s.animal_id
                                    })
                            }["GradebookPage.useEffect.fetchStudents.mapped"]);
                            setStudents(mapped);
                        }
                    } catch (error) {
            ...
            }["GradebookPage.useEffect.fetchStudents"];
            fetchStudents();
        }
    }["GradebookPage.useEffect"], []);
...
_s(GradebookPage, "NpwIBhziVx3iR79PGkELjAJZCrw=");
_c = GradebookPage;
var _c;
...
//# sourceMappingURL=_37b31971._.js.map