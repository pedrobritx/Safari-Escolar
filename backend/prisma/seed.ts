...
async function main() {
	...
	const students = [
		...
		{
			name: "Lucas Silva",
			animalAvatar: ANIMAL_AVATARS[1],
			classId: class1.id,
			familyId: family1.id,
		},
		{
			name: "Maria Santos",
			animalAvatar: ANIMAL_AVATARS[2],
			classId: class1.id,
			familyId: family2.id,
		},
		{
			name: "Julia Santos",
			animalAvatar: ANIMAL_AVATARS[3],
			classId: class1.id,
			familyId: family2.id,
		},
		{
			name: "Carlos Oliveira",
			animalAvatar: ANIMAL_AVATARS[4],
			classId: class1.id,
			familyId: family3.id,
		},
		{
			name: "Ana Oliveira",
			animalAvatar: ANIMAL_AVATARS[5],
			classId: class1.id,
			familyId: family3.id,
		},
		// Class 2 students
		...
		{
			name: "Beatriz Costa",
			animalAvatar: ANIMAL_AVATARS[7],
			classId: class2.id,
			familyId: family4.id,
		},
		{
			name: "Gabriel Souza",
			animalAvatar: ANIMAL_AVATARS[8],
			classId: class2.id,
			familyId: null,
		},
		{
			name: "Larissa Pereira",
			animalAvatar: ANIMAL_AVATARS[9],
			classId: class2.id,
			familyId: null,
		},
		{
			name: "Mateus Lima",
			animalAvatar: ANIMAL_AVATARS[10],
			classId: class2.id,
			familyId: null,
		},
		{
			name: "Sofia Alves",
			animalAvatar: ANIMAL_AVATARS[11],
			classId: class2.id,
			familyId: null,
		},
	];
